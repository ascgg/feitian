...
export default class ReadOnlyGrid extends Component {
  static propTypes = {
  ...
  constructor(props) {
    ...
    this.gridOptions = {
          ...
          const func = async (type) => {
            ...
            switch (type) {
              case 'num':
                ...
                await backend.sync.editTable(name, event.node.data.id, v, errorHandler);
                break;
              case 'str':
      ...
      overlayNoRowsTemplate: '<span style="padding: 10px; border: 2px solid red; background: red;">数字格式错误</span>'
      */
    };
  }
